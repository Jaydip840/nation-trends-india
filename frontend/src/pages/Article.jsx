...
const Article = () => {
  ...
  const BASE_URL = 'https://nation-trends-india.vercel.app';
  const shareUrl = typeof window !== 'undefined' ? window.location.href : `${BASE_URL}/article/${slug}`;

  const getAbsoluteImageUrl = (url) => {
    if (!url) return `${BASE_URL}/nt-favicon.png`;
                    ...
                    <div className="flex flex-col md:items-end justify-center">
                      ...
                      <div className="flex items-center gap-3">
                        <button
                          ...
                          className={`text-[10px] font-black uppercase tracking-[0.2em] px-5 py-2.5 border transition-all duration-300 rounded-[4px] ${currentUser?.savedArticles?.includes(article.id)
